...
<<<<<<< HEAD
    ...
    public void setUp() throws Exception {
        ham = new hammurabi.nick();
    }

//    @Test
//    public final void testHowManyAcresToBuy() {
//        int prices = 100;
//        int bushels = 200;
//        int acresBought = 200;
//
//        ham.askHowManyAcresToBuy(prices, bushels);
//
//        Assert.assertFalse(prices * acresBought > bushels);
//    }
//}
//
//    }
//    public int askHowManyAcresToBuy(int price, int bushels){
//        int acresBought = getNumber("How many Acres to you want to buy?");
